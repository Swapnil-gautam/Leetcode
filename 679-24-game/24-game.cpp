...
//         //             break;
//         //         }
//         //         smallequ = smallequ + equation[i];
//         //     }else{
//         //         restofequ = restofequ + equation[i];
//         //     }
//         //     i++;
//         // }
//         // string rest = equation.substr(i, n-i);
//         // cout << "rest: " << rest << endl;
//         // cout << "smallequ: " << smallequ << endl;
//         // cout << "restofequ: " << restofequ << endl;
//         // cout << "full rest : " << restofequ + " t " + rest << endl;

//         // str t = "0";
//         // int a = smallequ[]

//         for(int i = 4; i < n; i++ ){
//             if(equation[i-4] == '(' && equation[i] == ')'){
//                 smallequ = smallequ + equation.substr(i-4, 5);
//                 break;
//             }
//         }
//         cout <<"smallequ: " << smallequ << endl;
