...
//         peopleQueue.push(delay);
//         // unordered_map<queue<int>, queue<int>> queuemap;
//         for(int i = 1; i < n; i++){
//             queue<int> temp;
//             // cout << "*************" << endl;
//             // if(queuemap.find(peopleQueue) != queuemap.end()){
//             //     peopleQueue = queuemap[peopleQueue];
//             // }else{
//                 while(!peopleQueue.empty()){
//                     // cout << peopleQueue.front() << endl;
//                     if(peopleQueue.front()-1 > (delay - forget)){
//                         temp.push(peopleQueue.front()-1);
//                         if(peopleQueue.front()-1 <= 0){
//                             temp.push(delay);
//                         }
//                     }
//                     peopleQueue.pop();
//                 } 
//                 // queuemap[peopleQueue] = temp;
//                 peopleQueue = temp;
//             // }
//         }
